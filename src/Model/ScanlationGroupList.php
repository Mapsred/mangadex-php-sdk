...
/**
 * ScanlationGroupList Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class ScanlationGroupList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'ScanlationGroupList';
    ...
    private static $openAPITypes = [
        self::RESULTS => '\MangadexSDK\Model\ScanlationGroupResponse[]',
        self::LIMIT => 'int',
        self::OFFSET => 'int',
        self::TOTAL => 'int'
    ];
     ...
     * Gets results
     *
     * @return ScanlationGroupResponse[]|null
     */
     ...
     * Sets results
     *
     * @param ScanlationGroupResponse[]|null $results results
     */
