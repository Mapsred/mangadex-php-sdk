 ...
 */
final class CoverList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'CoverList';
    ...
    private static $openAPITypes = [
        self::RESULTS => '\MangadexSDK\Model\CoverResponse[]',
        self::LIMIT => 'int',
        self::OFFSET => 'int',
        self::TOTAL => 'int'
    ];
     ...
     * Sets results
     *
     * @param CoverResponse[]|null $results results
     */
