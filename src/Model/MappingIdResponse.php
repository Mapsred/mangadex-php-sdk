...
/**
 * MappingIdResponse Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class MappingIdResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'MappingIdResponse';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\MangadexSDK\Model\MappingId',
     ...
     * Gets data
     */
    public function getData(): ?MappingId
    {
     ...
     * Sets data
     *
     * @param MappingId|null $data data
     */
    public function setData(?MappingId $data): self
    {
