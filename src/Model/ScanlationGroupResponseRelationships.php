...
/**
 * ScanlationGroupResponseRelationships Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class ScanlationGroupResponseRelationships implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'ScanlationGroupResponse_relationships';
