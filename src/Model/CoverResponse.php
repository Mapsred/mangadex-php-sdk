...
/**
 * CoverResponse Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class CoverResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'CoverResponse';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\MangadexSDK\Model\Cover',
     ...
     * Sets data
     *
     * @param Cover|null $data data
     */
    public function setData(?Cover $data): self
    {
