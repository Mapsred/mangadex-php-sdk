...
/**
 * ScanlationGroupEdit Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class ScanlationGroupEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'ScanlationGroupEdit';
    ...
    public function setVersion(int $version): self
    {
        ...
        if (($version < 1)) {
            throw new \InvalidArgumentException('invalid value for $version when calling ScanlationGroupEdit., must be bigger than or equal to 1.');
        }
