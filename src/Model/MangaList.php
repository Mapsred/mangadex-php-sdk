 ...
 */
final class MangaList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'MangaList';
    ...
    private static $openAPITypes = [
        self::RESULTS => '\MangadexSDK\Model\MangaResponse[]',
        self::LIMIT => 'int',
        self::OFFSET => 'int',
        self::TOTAL => 'int'
    ];
     ...
     * Sets results
     *
     * @param MangaResponse[]|null $results results
     */
