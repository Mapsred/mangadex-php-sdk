...
final class Manga implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'Manga';
    ...
    private static $openAPITypes = [
        self::ID => 'string',
        self::TYPE => 'string',
        self::ATTRIBUTES => '\Mapsred\MangadexSDK\Model\MangaAttributes'
    ];
    /**
     * @var string
     */
     ...
     * Gets attributes
     *
     * @return MangaAttributes|null
     */
    public function getAttributes(): ?MangaAttributes
    {
     ...
     * Sets attributes
     *
     * @param MangaAttributes|null $attributes attributes
     */
    public function setAttributes(?MangaAttributes $attributes): self
    {
