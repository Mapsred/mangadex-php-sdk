...
/**
 * CustomListList Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class CustomListList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'CustomListList';
    ...
    private static $openAPITypes = [
        self::RESULTS => '\MangadexSDK\Model\CustomListResponse[]',
        self::LIMIT => 'int',
        self::OFFSET => 'int',
        self::TOTAL => 'int'
    ];
     ...
     * Gets results
     *
     * @return CustomListResponse[]|null
     */
     ...
     * Sets results
     *
     * @param CustomListResponse[]|null $results results
     */
