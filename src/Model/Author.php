...
final class Author implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'Author';
    ...
    private static $openAPITypes = [
        self::ID => 'string',
        self::TYPE => 'string',
        self::ATTRIBUTES => '\Mapsred\MangadexSDK\Model\AuthorAttributes'
    ];
    /**
     * @var string
     */
     ...
     * Gets attributes
     *
     * @return AuthorAttributes|null
     */
    public function getAttributes(): ?AuthorAttributes
    {
     ...
     * Sets attributes
     *
     * @param AuthorAttributes|null $attributes attributes
     */
    public function setAttributes(?AuthorAttributes $attributes): self
    {
