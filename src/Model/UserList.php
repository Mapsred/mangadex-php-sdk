...
final class UserList implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'UserList';
    ...
    private static $openAPITypes = [
        self::RESULTS => '\Mapsred\MangadexSDK\Model\UserResponse[]',
        self::LIMIT => 'int',
        self::OFFSET => 'int',
        self::TOTAL => 'int'
    ];
     ...
     * Sets results
     *
     * @param UserResponse[]|null $results results
     */
