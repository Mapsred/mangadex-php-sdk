 ...
 */
final class UserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'UserResponse';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\MangadexSDK\Model\User',
