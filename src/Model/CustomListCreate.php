...
/**
 * CustomListCreate Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class CustomListCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'CustomListCreate';
    ...
    public function setVersion(?int $version): self
    {
        ...
        if (!is_null($version) && ($version < 1)) {
            throw new \InvalidArgumentException('invalid value for $version when calling CustomListCreate., must be bigger than or equal to 1.');
        }
