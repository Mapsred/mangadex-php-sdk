...
final class TagAttributes implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'TagAttributes';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container[self::GROUP] = $data[self::GROUP] ?? null;
    ...
    {
        return $this->container[self::GROUP];
    }
    ...
    {
        $this->container[self::GROUP] = $group;
    ...
    public function setVersion(?int $version): self
    {
        ...
        if (!is_null($version) && ($version < 1)) {
            throw new InvalidArgumentException('invalid value for $version when calling TagAttributes., must be bigger than or equal to 1.');
        }
