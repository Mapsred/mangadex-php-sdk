...
final class Cover implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'Cover';
    ...
    private static $openAPITypes = [
        self::ID => 'string',
        self::TYPE => 'string',
        self::ATTRIBUTES => '\Mapsred\MangadexSDK\Model\CoverAttributes'
    ];
    /**
     * @var string
     */
    ...
    const TYPE_COVER_ART = 'cover_art';
     ...
     * Gets attributes
     *
     * @return CoverAttributes|null
     */
    public function getAttributes(): ?CoverAttributes
    {
     ...
     * Sets attributes
     *
     * @param CoverAttributes|null $attributes attributes
     */
    public function setAttributes(?CoverAttributes $attributes): self
    {
