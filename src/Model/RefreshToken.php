 ...
 */
final class RefreshToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'RefreshToken';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container[self::TOKEN] === null) {
            $invalidProperties[] = "'token' can't be null";
        }
        if ((mb_strlen($this->container[self::TOKEN]) < 1)) {
    ...
    public function setToken(string $token): self
    {
        ...
        if ((mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling RefreshToken., must be bigger than or equal to 1.');
        }
