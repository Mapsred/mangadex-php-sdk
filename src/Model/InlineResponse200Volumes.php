...
/**
 * InlineResponse200Volumes Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class InlineResponse200Volumes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'inline_response_200_volumes';
    ...
    private static $openAPITypes = [
        self::VOLUME => 'string',
        self::COUNT => 'int',
        self::CHAPTERS => 'array<string,\MangadexSDK\Model\InlineResponse200Chapters>'
    ];
    /**
     * @var string
     */
     ...
     * @var string
     */
    private const CHAPTERS = 'chapters';
    /**
     * Constructor
     *
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container[self::CHAPTERS] = $data[self::CHAPTERS] ?? null;
    }
    /**
     ...
     * Gets chapters
     *
     * @return array<string, InlineResponse200Chapters>|null
     */
    public function getChapters(): ?array
    {
        return $this->container[self::CHAPTERS];
    }

    /**
     * Sets chapters
     *
     * @param array<string, InlineResponse200Chapters>|null $chapters chapters
     */
    public function setChapters(?array $chapters): self
    {
        $this->container[self::CHAPTERS] = $chapters;
