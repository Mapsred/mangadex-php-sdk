...
final class Tag implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'Tag';
    ...
    private static $openAPITypes = [
        self::ID => 'string',
        self::TYPE => 'string',
        self::ATTRIBUTES => '\Mapsred\MangadexSDK\Model\TagAttributes'
    ];
    /**
     * @var string
     */
     ...
     * Sets attributes
     *
     * @param TagAttributes|null $attributes attributes
     */
    public function setAttributes(?TagAttributes $attributes): self
    {
