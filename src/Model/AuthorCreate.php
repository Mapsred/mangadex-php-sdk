...
/**
 * AuthorCreate Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class AuthorCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'AuthorCreate';
    ...
    public function setVersion(?int $version): self
    {
        ...
        if (!is_null($version) && ($version < 1)) {
            throw new \InvalidArgumentException('invalid value for $version when calling AuthorCreate., must be bigger than or equal to 1.');
        }
