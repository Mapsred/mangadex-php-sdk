...
final class User implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'User';
    ...
    private static $openAPITypes = [
        self::ID => 'string',
        self::TYPE => 'string',
        self::ATTRIBUTES => '\Mapsred\MangadexSDK\Model\UserAttributes'
    ];
    /**
     * @var string
     */
     ...
     * Sets attributes
     *
     * @param UserAttributes|null $attributes attributes
     */
    public function setAttributes(?UserAttributes $attributes): self
    {
