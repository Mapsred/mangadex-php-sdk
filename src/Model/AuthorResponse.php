...
/**
 * AuthorResponse Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class AuthorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'AuthorResponse';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\MangadexSDK\Model\Author',
     ...
     * Gets data
     */
    public function getData(): ?Author
    {
     ...
     * Sets data
     *
     * @param Author|null $data data
     */
    public function setData(?Author $data): self
    {
