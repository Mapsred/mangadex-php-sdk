...
/**
 * CustomListResponse Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class CustomListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'CustomListResponse';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\MangadexSDK\Model\CustomList',
        self::RELATIONSHIPS => '\MangadexSDK\Model\Relationship[]'
    ];
    /**
     * @var string
     */
     ...
     * Gets data
     */
    public function getData(): ?CustomList
    {
     ...
     * Sets data
     *
     * @param CustomList|null $data data
     */
    public function setData(?CustomList $data): self
    {
