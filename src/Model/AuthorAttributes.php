...
/**
 * AuthorAttributes Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class AuthorAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'AuthorAttributes';
    ...
    private static $openAPITypes = [
        ...
        self::BIOGRAPHY => 'array<string,string>',
        self::VERSION => 'int',
     ...
     * @var string
     */
    private const BIOGRAPHY = 'biography';
    /**
     * @var string
     */
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container[self::IMAGE_URL] = $data[self::IMAGE_URL] ?? null;
        $this->container[self::BIOGRAPHY] = $data[self::BIOGRAPHY] ?? null;
    ...
    private static $setters = [
        self::NAME => 'setName',
        self::IMAGE_URL => 'setImageUrl',
        self::BIOGRAPHY => 'setBiography',
    ...
    private static $getters = [
        self::NAME => 'getName',
        self::IMAGE_URL => 'getImageUrl',
        self::BIOGRAPHY => 'getBiography',
    ...
    {
        return $this->container[self::IMAGE_URL];
    }
    ...
    {
        $this->container[self::IMAGE_URL] = $image_url;
    ...
    {
        return $this->container[self::BIOGRAPHY];
    }

    /**
     * Sets biography
     *
     * @param array<string,string>|null $biography biography
     */
    public function setBiography(?array $biography): self
    {
        $this->container[self::BIOGRAPHY] = $biography;
    ...
    public function setVersion(?int $version): self
    {
        ...
        if (!is_null($version) && ($version < 1)) {
            throw new \InvalidArgumentException('invalid value for $version when calling AuthorAttributes., must be bigger than or equal to 1.');
        }
