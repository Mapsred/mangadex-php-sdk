...
/**
 * ChapterResponse Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class ChapterResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'ChapterResponse';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\MangadexSDK\Model\Chapter',
     ...
     * Gets data
     */
    public function getData(): ?Chapter
    {
     ...
     * Sets data
     *
     * @param Chapter|null $data data
     */
    public function setData(?Chapter $data): self
    {
