...
final class ScanlationGroupResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'ScanlationGroupResponse';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\Mapsred\MangadexSDK\Model\ScanlationGroup',
        self::RELATIONSHIPS => '\Mapsred\MangadexSDK\Model\ScanlationGroupResponseRelationships[]'
    ];
    /**
     * @var string
     */
     ...
     * Gets data
     *
     * @return ScanlationGroup|null
     */
    public function getData(): ?ScanlationGroup
    {
     ...
     * Sets data
     *
     * @param ScanlationGroup|null $data data
     */
    public function setData(?ScanlationGroup $data): self
    {
     ...
     * Gets relationships
     *
     * @return ScanlationGroupResponseRelationships[]|null
     */
     ...
     * Sets relationships
     *
     * @param ScanlationGroupResponseRelationships[]|null $relationships relationships
     */
