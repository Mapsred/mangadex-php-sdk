...
/**
 * ScanlationGroupResponse Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
...
final class ScanlationGroupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\MangadexSDK\Model\ScanlationGroup',
        self::RELATIONSHIPS => '\MangadexSDK\Model\ScanlationGroupResponseRelationships[]'
    ];
    /**
     * @var string
     */
