...
/**
 * RecoverCompleteBody Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class RecoverCompleteBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'RecoverCompleteBody';
    ...
    {
        $this->container[self::NEW_PASSWORD] = $data[self::NEW_PASSWORD] ?? null;
    }
    /**
    ...
    private static $setters = [
        self::NEW_PASSWORD => 'setNewPassword'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container[self::NEW_PASSWORD] === null) {
            $invalidProperties[] = "'new_password' can't be null";
        }
        if ((mb_strlen($this->container[self::NEW_PASSWORD]) > 1024)) {
            $invalidProperties[] = "invalid value for 'new_password', the character length must be smaller than or equal to 1024.";
        }

        if ((mb_strlen($this->container[self::NEW_PASSWORD]) < 8)) {
    ...
    {
        return $this->container[self::NEW_PASSWORD];
    }
    /**
    ...
    private static $getters = [
        self::NEW_PASSWORD => 'getNewPassword'
    ];
    ...
    {
        if ((mb_strlen($new_password) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $new_password when calling RecoverCompleteBody., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($new_password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $new_password when calling RecoverCompleteBody., must be bigger than or equal to 8.');
        }

        $this->container[self::NEW_PASSWORD] = $new_password;
