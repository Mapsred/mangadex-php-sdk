...
/**
 * MangaResponse Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class MangaResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'MangaResponse';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::DATA => '\MangadexSDK\Model\Manga',
