...
final class Chapter implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'Chapter';
    ...
    private static $openAPITypes = [
        self::ID => 'string',
        self::TYPE => 'string',
        self::ATTRIBUTES => '\Mapsred\MangadexSDK\Model\ChapterAttributes'
    ];
    /**
     * @var string
     */
     ...
     * Gets attributes
     *
     * @return ChapterAttributes|null
     */
    public function getAttributes(): ?ChapterAttributes
    {
     ...
     * Sets attributes
     *
     * @param ChapterAttributes|null $attributes attributes
     */
    public function setAttributes(?ChapterAttributes $attributes): self
    {
