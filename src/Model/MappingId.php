...
final class MappingId implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'MappingId';
    ...
    private static $openAPITypes = [
        self::ID => 'string',
        self::TYPE => 'string',
        self::ATTRIBUTES => '\Mapsred\MangadexSDK\Model\MappingIdAttributes'
    ];
    /**
     * @var string
     */
    ...
    const TYPE_MAPPING_ID = 'mapping_id';
     ...
     * Gets attributes
     *
     * @return MappingIdAttributes|null
     */
    public function getAttributes(): ?MappingIdAttributes
    {
     ...
     * Sets attributes
     *
     * @param MappingIdAttributes|null $attributes attributes
     */
    public function setAttributes(?MappingIdAttributes $attributes): self
    {
