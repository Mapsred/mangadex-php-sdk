 ...
 */
final class ChapterList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'ChapterList';
    ...
    private static $openAPITypes = [
        self::RESULTS => '\MangadexSDK\Model\ChapterResponse[]',
        self::LIMIT => 'int',
        self::OFFSET => 'int',
        self::TOTAL => 'int'
    ];
     ...
     * Sets results
     *
     * @param ChapterResponse[]|null $results results
     */
