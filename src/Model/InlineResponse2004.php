 ...
 */
final class InlineResponse2004 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'inline_response_200_4';
    ...
    private static $openAPITypes = [
        self::RESULT => 'string',
        self::STATUSES => 'array<string,string>'
    ];
    /**
     * @var string
     */
     ...
     * @var string
     */
    private const STATUSES = 'statuses';
    /**
     * Constructor
     *
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container[self::STATUSES] = $data[self::STATUSES] ?? null;
    }
    /**
     ...
     * @return string[]
     */
    public function getStatusesAllowableValues(): array
    {
        return [
            self::STATUSES_READING,
            self::STATUSES_ON_HOLD,
            self::STATUSES_PLAN_TO_READ,
            self::STATUSES_DROPPED,
            self::STATUSES_RE_READING,
            self::STATUSES_COMPLETED,
        ];
    }
    /**
    ...
    const STATUSES_READING = 'reading';
    const STATUSES_ON_HOLD = 'on_hold';
    const STATUSES_PLAN_TO_READ = 'plan_to_read';
    const STATUSES_DROPPED = 'dropped';
    const STATUSES_RE_READING = 're_reading';
    const STATUSES_COMPLETED = 'completed';
    ...
    {
        return $this->container[self::STATUSES];
    }

    /**
     * Sets statuses
     *
     * @param array<string,string>|null $statuses statuses
     */
    public function setStatuses(?array $statuses): self
    {
        ...
        $this->container[self::STATUSES] = $statuses;
