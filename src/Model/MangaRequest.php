...
/**
 * MangaRequest Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class MangaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'MangaRequest';
    ...
    public function setOriginalLanguage(?string $original_language): self
    {
        ...
        if (!is_null($original_language) && (!preg_match("/^[a-zA-Z\\-]{2,5}$/", $original_language))) {
            throw new \InvalidArgumentException("invalid value for $original_language when calling MangaRequest., must conform to the pattern /^[a-zA-Z\\-]{2,5}$/.");
        }
    ...
    public function setYear(?int $year): self
    {
        ...
        if (!is_null($year) && ($year > 9999)) {
            throw new \InvalidArgumentException('invalid value for $year when calling MangaRequest., must be smaller than or equal to 9999.');
        }
        if (!is_null($year) && ($year < 1)) {
            throw new \InvalidArgumentException('invalid value for $year when calling MangaRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion(?int $version): self
    {
        ...
        if (!is_null($version) && ($version < 1)) {
            throw new \InvalidArgumentException('invalid value for $version when calling MangaRequest., must be bigger than or equal to 1.');
        }
