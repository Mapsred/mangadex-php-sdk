...
final class Login implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'Login';
    ...
    public function setUsername(string $username): self
    {
        if ((mb_strlen($username) > 64)) {
            throw new InvalidArgumentException('invalid length for $username when calling Login., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($username) < 1)) {
            throw new InvalidArgumentException('invalid length for $username when calling Login., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword(string $password): self
    {
        if ((mb_strlen($password) > 1024)) {
            throw new InvalidArgumentException('invalid length for $password when calling Login., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($password) < 8)) {
            throw new InvalidArgumentException('invalid length for $password when calling Login., must be bigger than or equal to 8.');
        }
