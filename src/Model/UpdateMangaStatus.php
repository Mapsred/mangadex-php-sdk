...
/**
 * UpdateMangaStatus Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class UpdateMangaStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'UpdateMangaStatus';
    ...
    public function getStatusAllowableValues(): array
    {
        return [
            self::STATUS_READING,
            self::STATUS_ON_HOLD,
            self::STATUS_PLAN_TO_READ,
            self::STATUS_DROPPED,
            self::STATUS_RE_READING,
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container[self::STATUS] === null) {
    ...
    const STATUS_PLAN_TO_READ = 'plan_to_read';
    const STATUS_DROPPED = 'dropped';
    const STATUS_RE_READING = 're_reading';
