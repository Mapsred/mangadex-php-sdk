...
/**
 * CreateScanlationGroup Class Doc Comment
 *
 * @category Class
 * @package  MangadexSDK
 * @author   OpenAPI Generator team
 ...
 */
final class CreateScanlationGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    private static $openAPIModelName = 'CreateScanlationGroup';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container[self::MEMBERS] = $data[self::MEMBERS] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container[self::NAME] === null) {
     ...
     * Sets leader
     *
     * @param string|null $leader leader
     */
    ...
    {
        return $this->container[self::MEMBERS];
    }
    ...
    {
        $this->container[self::MEMBERS] = $members;
    ...
    public function setVersion(?int $version): self
    {
        ...
        if (!is_null($version) && ($version < 1)) {
            throw new \InvalidArgumentException('invalid value for $version when calling CreateScanlationGroup., must be bigger than or equal to 1.');
        }
