...
use MangadexSDK\Model\CheckResponse;
use MangadexSDK\Model\ErrorResponse;
use MangadexSDK\Model\Login;
use MangadexSDK\Model\LoginResponse;
use MangadexSDK\Model\LogoutResponse;
use MangadexSDK\Model\ModelInterface;
use MangadexSDK\Model\RefreshResponse;
use MangadexSDK\Model\RefreshToken;
...
final class AuthApi
{
     ...
     * @throws ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MangadexSDK\Model\CheckResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAuthCheckWithHttpInfo()
    {
        ...
        try {
            ...
            if ($statusCode === 200) {
                if ('\MangadexSDK\Model\CheckResponse' === '\SplFileObject') {
                    $content = $response->getBody(); //stream goes to serializer
                } else {
                    $content = (string) $response->getBody();
                }
                return [
                    ObjectSerializer::deserialize($content, '\MangadexSDK\Model\CheckResponse', []),
                    $response->getStatusCode(),
                    $response->getHeaders()
                ];
            }

            $returnType = '\MangadexSDK\Model\CheckResponse';
            ...
            if ($e->getCode() === 200) {
                $data = ObjectSerializer::deserialize(
                    $e->getResponseBody(),
                    '\MangadexSDK\Model\CheckResponse',
     ...
     * @throws ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MangadexSDK\Model\LoginResponse|\MangadexSDK\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postAuthLoginWithHttpInfo(Login $login = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MangadexSDK\Model\LoginResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MangadexSDK\Model\LoginResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\MangadexSDK\Model\LoginResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MangadexSDK\Model\LoginResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MangadexSDK\Model\LogoutResponse|\MangadexSDK\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postAuthLogoutWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MangadexSDK\Model\LogoutResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MangadexSDK\Model\LogoutResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 503:
            ...
            $returnType = '\MangadexSDK\Model\LogoutResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MangadexSDK\Model\LogoutResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MangadexSDK\Model\RefreshResponse|\MangadexSDK\Model\ErrorResponse|\MangadexSDK\Model\RefreshResponse|\MangadexSDK\Model\RefreshResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postAuthRefreshWithHttpInfo(RefreshToken $refresh_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MangadexSDK\Model\RefreshResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MangadexSDK\Model\RefreshResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\MangadexSDK\Model\RefreshResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MangadexSDK\Model\RefreshResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
