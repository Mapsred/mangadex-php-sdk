...
use MangadexSDK\Model\MappingIdBody;
use MangadexSDK\Model\MappingIdResponse;
...
final class LegacyApi
{
     ...
     * @throws ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MangadexSDK\Model\MappingIdResponse[]|\MangadexSDK\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postLegacyMappingWithHttpInfo(MappingIdBody $mapping_id_body = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MangadexSDK\Model\MappingIdResponse[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MangadexSDK\Model\MappingIdResponse[]', []),
            ...
            $returnType = '\MangadexSDK\Model\MappingIdResponse[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MangadexSDK\Model\MappingIdResponse[]',
    ...
    public function postLegacyMappingRequest(MappingIdBody $mapping_id_body = null): Request
    {
        ...
        if (isset($mapping_id_body)) {
            ...
            if ($multipart) {
                ...
                // for HTTP post (form)
                $httpBody = build_query(self::FORM_PARAMS);
            }
        }
        ...
        $query = build_query(self::QUERY_PARAMS);
        return new Request(
            'POST',
