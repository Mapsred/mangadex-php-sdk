...
use MangadexSDK\Model\InlineObject1;
...
final class CaptchaApi
{
     ...
     * @throws ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MangadexSDK\Model\InlineResponse2002|\MangadexSDK\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function postCaptchaSolveRequest(InlineObject1 $inline_object1 = null): Request
    {
        ...
        if (isset($inline_object1)) {
            if ($headers['Content-Type'] === self::APPLICATION_JSON) {
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($inline_object1));
            } else {
