...
final class AtHomeApi
{
     ...
     * @throws ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MangadexSDK\Model\InlineResponse2003|\MangadexSDK\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAtHomeServerChapterIdWithHttpInfo(string $chapter_id, bool $force_port443 = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MangadexSDK\Model\InlineResponse2003' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MangadexSDK\Model\InlineResponse2003', []),
            ...
            $returnType = '\MangadexSDK\Model\InlineResponse2003';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MangadexSDK\Model\InlineResponse2003',
